# Некоммерческая лицензия SwiftNetPulse — проект 1.0
...
английский файл [LICENSE-NONCOMMERCIAL.md](../../LICENSE-NONCOMMERCIAL.md).
Приоритет языка не действует, пока документ остаётся черновиком.
