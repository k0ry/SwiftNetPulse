...
Английский предлагается как юридически определяющий текст, русские переводы в
`docs/ru/` — информационные. Это соотношение должен принять правообладатель при
финализации; данный файл не делает черновики действующими.
...
- `LICENSE`: статус и схема двух альтернативных вариантов лицензирования.
  Информационный перевод: [LICENSE.md](LICENSE.md).
- `LICENSE-NONCOMMERCIAL.md`: самостоятельный проект бесплатной ограниченной
  лицензии, включая изменение и распространение. Перевод:
  [LICENSE-NONCOMMERCIAL.md](LICENSE-NONCOMMERCIAL.md).
- `COMMERCIAL-LICENSE.md`: заполняемый проект условий платного договора. Перевод:
